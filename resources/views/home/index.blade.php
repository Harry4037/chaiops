...
<section class="online-store">
    <div class="container">
        ...
        <ul class="categories row">
            ...
            <li>
                <button data-filter=".type1">Coffee</button>
            </li>
            <li>
                <button data-filter=".type2">Beans</button>
            </li>
            <li>
                <button data-filter=".type3">Organic</button>
            </li>
            <li>
                <button data-filter=".type4">Type 4</button>
            </li>
            <li>
                <button data-filter=".type5">Type 5</button>
            </li>
        </ul>
        <div class="store-product-list row">
            ...
            <div class="store-product-wrapper grid-item type3">
                <div class="store-product">
                    <div class="imgLiquidFill imgLiquid item-image">
                        <img src="/assets/images/book-table-img.jpg" alt="product item">
                    </div>
                    <div class="product-detail">
            ...
            <div class="store-product-wrapper grid-item type3">
                <div class="store-product">
                    <div class="imgLiquidFill imgLiquid item-image">
                        <img src="/assets/images/order-type2.png" alt="product item">
                    </div>
                    <div class="product-detail">
            ...
            <div class="store-product-wrapper grid-item type4 type3">
                <div class="store-product">
                    <div class="imgLiquidFill imgLiquid item-image">
                        <img src="/assets/images/store/store-product.jpg" alt="product item">
                    </div>
                    <div class="product-detail">
            ...
            <div class="store-product-wrapper grid-item type3">
                <div class="store-product">
                    <div class="imgLiquidFill imgLiquid item-image">
                        <img src="/assets/images/blog-list/blog-img1.jpg" alt="product item">
                    </div>
                    <div class="product-detail">
            ...
            <div class="store-product-wrapper grid-item type2">
                <div class="store-product">
                    <div class="imgLiquidFill imgLiquid item-image">
                        <img src="/assets/images/blog-list/blog-img3.jpg" alt="product item">
                    </div>
                    <div class="product-detail">
            ...
            <div class="store-product-wrapper grid-item type2">
                <div class="store-product">
                    <div class="imgLiquidFill imgLiquid item-image">
                        <img src="/assets/images/blog-list/blog-img4.jpg" alt="product item">
                    </div>
                    <div class="product-detail">
            ...
            <div class="store-product-wrapper grid-item type5 type1">
                <div class="store-product">
                    <div class="imgLiquidFill imgLiquid item-image">
                        <img src="/assets/images/blog-dtl/coffeebeans.jpg" alt="product item">
                    </div>
                    <div class="product-detail">
                        <div class="product-rate">$39</div>
                        <h3>Vienna Coffee</h3>
